...
public class Q00709_PathToBecomingALordDion extends Quest
{
	...
	{
		super(709, "Path to Becoming a Lord - Dion");
		addStartNpc(CROSBY);
		addKillId(OL_MAHUMS);
	...
	public String onEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "35142-10.html":
			{
				if (castleOwner != null)
				{
					final NpcSay packet = new NpcSay(npc.getObjectId(), ChatType.NPC_SHOUT, npc.getId(), player.getName() + " has become lord of the Town of Dion. Long may he reign!");
	...
	public void onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		if ((qs != null) && qs.isCond(6) && ArrayUtil.contains(OL_MAHUMS, npc.getId()))
		{
		...
		if ((qs != null) && (qs.getState() == State.STARTED) && qs.isCond(0) && isLordAvailable(8, qs) && ArrayUtil.contains(MANDRAGORAS, npc.getId()) && (getQuestItemsCount(killer, MANDRAGORA_ROOT) < 100))
		{
